...
export const Layout: React.FC<LayoutProps> = ({ user, children, onLogout }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      {/* Header */}
      <header className="bg-[#003366] text-white relative py-4">
        ...
        {user && (
          <div className="absolute top-4 right-4 flex items-center space-x-4">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-3 py-1 text-sm font-semibold hover:bg-white hover:bg-opacity-20 rounded-lg transition-all duration-200"
            >
        ...
        {/* Centered Logo and College Name */}
